...
class DetalleProgramas(models.Model):
    ...
    vp_calificador = models.CharField("Calificador", max_length=5, blank=True, null=True)
    ...
    vp_sistema = models.CharField("Sistema", max_length=4, blank=True, null=True)
...
class RegistroCalificacion(models.Model):
    ...
    idioma_original = models.CharField(max_length=18)
